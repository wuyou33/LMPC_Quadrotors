function [x_safe, u_safe, Q_safe] = ...
	LMPC_obst(x1, x_first, u_first, N, n_iter, data, anim_plot)

x_safe{1} = x_first; % Store first trajectory
u_safe{1} = u_first;
...
for j = 1:1:n_iter
	...
	while x1(11) < data.L_track
		...
		u1 = LMPC_OP_obst(x1, A, B, c, A_ch, b_ch, a_cf, b_cf, N, data);
